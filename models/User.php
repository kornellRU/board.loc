...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['sex', 'in', 'range' => [self::SEX_MALE, self::SEX_FEMALE, self::SEX_UNCKNOW]],
            ['sex', 'default', 'value' => self::SEX_UNCKNOW],
    ...
    public function UnlinkPhotoPosts()
    {
        $model=  self::find()->where(['id'=>$this->id])->one();
        if ($model->photo)
        {
            unlink('images/users/'.$model->photo);
        }
    }
    ...
    public function upload()
    {
        ...
        $this->imageFile->saveAs('images/users/' . $this->imageFile->baseName.'-'.$random . '.' . $this->imageFile->extension);

        $this->UnlinkPhotoPosts();
        $this->photo = $this->imageFile->baseName.'-'.$random . '.' . $this->imageFile->extension;
        $this->update(false);
    }
}
