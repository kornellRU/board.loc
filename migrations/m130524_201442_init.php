    ...
    public function up()
    {
        ...
        $this->batchInsert('{{%user}}', ['username', 'auth_key', 'password_hash', 'email', 'status', 'created_at', 'updated_at'], [
            ...
            [
                'author',
                \Yii::$app->security->generateRandomString(),
                \Yii::$app->security->generatePasswordHash('author@example.com'),
                'author@example.com',
                User::STATUS_ACTIVE,
                time(),
                time()
        ...
        $this->Insert('{{%auth_rule}}', ['name' => 'isAuthorRule',
            'data' => 'O:21:"app\rbac\IsAuthorRule":3:{s:4:"name";s:12:"isAuthorRule";s:9:"createdAt";i:1527893853;s:9:"updatedAt";i:1527893853;}',
            'created_at' => time(),
            'updated_at' => time(),
        ]);
        ...
        $this->batchInsert('{{%auth_item}}', ['name', 'type', 'description', 'rule_name', 'created_at', 'updated_at'], [
            ...
            ['author', Item::TYPE_ROLE, 'author', NULL, time(), time()],
            ...
            ['UpdateAdOwn', Item::TYPE_PERMISSION, 'Редактирование только своего объявления', 'isAuthorRule', time(), time()],
            ['UpdateAd', Item::TYPE_PERMISSION, 'Редактирование объявления', NULL, time(), time()],
            ['DeleteAdOwn', Item::TYPE_PERMISSION, 'Удаление только своего объявления', 'isAuthorRule', time(), time()],
            ['DeleteAd', Item::TYPE_PERMISSION, 'Удаление объявления', NULL, time(), time()],
            ['userView', Item::TYPE_PERMISSION, \Yii::t('users', 'MIGRATION_USER_VIEW'), NULL, time(), time()],
            ['profileUpdate', Item::TYPE_PERMISSION, 'Редактирование профиля', NULL, time(), time()],
        ]);
        $this->batchInsert('{{%auth_item_child}}', ['parent', 'child'], [
            ...
            ['administrator', 'UpdateAd'],
            ['administrator', 'DeleteAd'],
            ...
            ['author', 'UpdateAdOwn'],
            ['author', 'DeleteAdOwn'],
            ['author', 'profileUpdate'],
            ['administrator', 'author'],
            ['userUpdateNoElderRank', 'userUpdate'],
            ['UpdateAdOwn', 'UpdateAd'],
            ['DeleteAdOwn', 'DeleteAd'],
        ]);
